...
b12 = new LeaderLine(b1, b2,
      {startPlug: 'disc',endPlug: 'arrow3', middleLabel: LeaderLine.pathLabel('x(n)', {fontFamily: 'Arial, sans-serif'})});
...
var ramp =generateUnitRampSignal(2,16)
console.log(ramp)
                ...
                var op1 = {
                  ...
                  // }
                    ...
                    if(cha=='1'){
                      ...
                      var data = [in1,op1];
                      var layout={title: 'Linear Convolving of sine sequence itself output plot',plot_bgcolor:'black', paper_bgcolor:'black',text_color:'blue',
                      font: {
                        family: 'Courier New, monospace',
                        size: 18,
                        color: '#7f7f7f'
